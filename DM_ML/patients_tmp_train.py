...
# CSV 파일 불러오기
admissions_df = pd.read_csv('data/train/admissions_train.csv')
patients_df = pd.read_csv('data/train/patients_train.csv')
icu_df = pd.read_csv('data/train/icustays_train.csv')
...
# 결과를 .pkl 파일로 저장
with open('data/patient_data_train.pkl', 'wb') as file:
